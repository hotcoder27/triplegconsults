...
const AdvisoryPage = () => {
  ...
  const advisoryServices = [
    ...
    },
    {
      ...
      icon: "💹",
      description: "Expert financial advisory for capital raising, mergers, acquisitions, and strategic transactions.",
    },
    {
    ...
    },
    {
      ...
      icon: "🔄",
      description: "Comprehensive guidance for business restructuring, growth strategies, and operational excellence.",
    },
    {
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20 pt-20">
          <div>
            ...
            <div className="prose prose-lg text-gray-600 leading-relaxed">
              <h2 className="text-2xl font-bold text-primary mb-4">TripleG Consulting – Advisory for What's Next</h2>
              <p className="mb-6">
                At TripleG, we don't just support your business—we partner in its journey forward. Our advisory team
                steps beyond the conventional role of number-crunchers to act as strategic collaborators invested in
                your long-term success.
              </p>
              <p className="mb-6">
                Think of us as your business's co-pilot—getting to know your operations from the inside out so we can
                guide you with clarity and precision. With deep industry insight and a proactive mindset, we help you
                navigate challenges, seize opportunities, and shape a future that aligns with your vision.
              </p>
              <p className="mb-6">
          ...
          <div className="relative">
            ...
            >
              <img
                src={bussdpImg}
                alt="Strategic business advisory consultation"
            ...
            >
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Leading our Advisory practice</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mb-20">
          <div className="text-center mb-16">
            ...
            >
              Our Comprehensive <span className="text-accent">Advisory Services</span>
            </h2>
                ...
                <div className="relative z-10 h-full flex flex-col">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center text-gray-700">
                      ...
                      ></div>
                      <span className="font-medium text-xs">Expert Guidance</span>
                    </div>
                  </div>
          ...
          <div className="w-full max-w-4xl">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
                Ready to transform your business strategy? Let's discuss how our advisory services can help you achieve
                your goals.
              </p>
            </div>
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      placeholder="Please describe your advisory needs and how we can help your business move forward..."
                      style={{
